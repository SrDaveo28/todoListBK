import { render, addNavbarFunc, animationNavbar, dateToTimestamp, timeStampToDateForm } from '../others/utils.js';
import { tareasListFront, addTareaFront } from '../views/templates.js';
import { postTareas } from '../apis/bdPost.js';
import { getUsersAll } from '../apis/bdCall.js';

export function addTarea(view, model) {
    view = {};

    view.tareasListFront = tareasListFront(model.user);

    view.addTarea = addTareaFront();
    render(view, true);
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-row align-items-center">
                                                    <input type="text" class="form-control form-control-lg me-3" id="inTxtTarea"
